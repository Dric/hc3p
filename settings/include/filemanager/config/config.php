...
$script = str_replace('/settings/include/filemanager/dialog.php', '', $script);
$base_url="http://".$_SERVER['HTTP_HOST'].$script;  // DON'T TOUCH (base url (only domain) of site (without final /)).
...
$thumbs_base_path = '../../../cache/thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
...
//**********************
$ext_img = array('jpg', 'jpeg', 'png', 'gif'); //Images
